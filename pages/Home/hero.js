        ...
        <section className="text-gray-600 body-font">
            <div className="container mx-auto flex px-5 py-0 md:py-24 md:flex-row flex-col items-center">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-5 md:mb-0 items-center text-center">
                    <h1 className="title-font text-xl font-bold md:text-3xl mb-4 md:font-medium text-gray-900 capitalize">Find the best technology
                    ...
                    <div className="flex justify-center">
                        <a href="#posts">
                            <button className="inline-flex text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded text-lg">Read Blogs</button>
                        </a>
                    </div>
                </div>
